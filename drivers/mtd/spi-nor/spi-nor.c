...
const struct spi_device_id spi_nor_ids[] = {
	...
	/* Turn off small sectors so we can use UBIFS */
	{ "n25q00aa11",  INFO(0x20bb21, 0, 64 * 1024, 2048, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | USE_FSR | SPI_NOR_FLASH_LOCK) },
	{ "n25q00aa13",  INFO(0x20ba21, 0, 64 * 1024, 2048, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | USE_FSR | SPI_NOR_FLASH_LOCK) },
